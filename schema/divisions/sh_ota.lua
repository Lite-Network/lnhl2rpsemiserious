...
ix.divisions.ota[1] = {
	...
	model_ldr = "models/combine_ground.mdl",
...
ix.divisions.ota[2] = {
	...
	name = "MACE",
	model = "models/combine_soldier.mdl",
	model_ldr = "models/combine_shotgun.mdl",
...
ix.divisions.ota[3] = {
	id = 3,
	name = "XRAY",
	model = "models/combine_advisor_s.mdl",
	model_ldr = "models/combine_advisor.mdl",
...
ix.divisions.ota[4] = {
	id = 4,
	name = "RANGER",
	model = "models/combine_nebula_s.mdl",
	model_ldr = "models/combine_nebula.mdl",
...
ix.divisions.ota[5] = {
	id = 5,
	name = "REAPER",
	model = "models/combine_hazard.mdl",
