...
ix.divisions.cca[1].weapons[5] = {"ix_stunstick", "ix_usp", "ix_mp7"}
ix.divisions.cca[1].weapons[6] = {"ix_stunstick", "ix_usp", "ix_mp7"}
ix.divisions.cca[1].weapons[7] = {"ix_stunstick", "ix_usp", "ix_mp7"}
ix.divisions.cca[1].weapons[8] = {"ix_stunstick", "ix_357", "ix_spas12"}
...
ix.divisions.cca[2].weapons[1] = {"ix_stunstick", "weapon_medkit"}
ix.divisions.cca[2].weapons[2] = {"ix_stunstick", "weapon_medkit"}
ix.divisions.cca[2].weapons[3] = {"ix_stunstick", "weapon_medkit", "ix_usp"}
ix.divisions.cca[2].weapons[4] = {"ix_stunstick", "weapon_medkit", "ix_usp"}
ix.divisions.cca[2].weapons[5] = {"ix_stunstick", "weapon_medkit", "ix_usp", "ix_mp7"}
ix.divisions.cca[2].weapons[6] = {"ix_stunstick", "weapon_medkit", "ix_usp", "ix_mp7"}
ix.divisions.cca[2].weapons[7] = {"ix_stunstick", "weapon_medkit", "ix_usp", "ix_mp7"}
ix.divisions.cca[2].weapons[8] = {"ix_stunstick", "weapon_medkit", "ix_357", "ix_mp7"}
ix.divisions.cca[2].weapons[9] = {"ix_stunstick", "weapon_medkit", "ix_357", "ix_mp7"}
...
ix.divisions.cca[3].weapons[5] = {"ix_stunstick", "ix_usp", "ix_mp7"}
ix.divisions.cca[3].weapons[6] = {"ix_stunstick", "ix_usp", "ix_mp7"}
ix.divisions.cca[3].weapons[7] = {"ix_stunstick", "ix_usp", "ix_mp7"}
ix.divisions.cca[3].weapons[8] = {"ix_stunstick", "ix_357", "ix_spas12"}
...
ix.divisions.cca[4].weapons[5] = {"ix_stunstick", "ix_usp", "ix_mp7"}
ix.divisions.cca[4].weapons[6] = {"ix_stunstick", "ix_usp", "ix_mp7"}
ix.divisions.cca[4].weapons[7] = {"ix_stunstick", "ix_usp", "ix_spas12"}
ix.divisions.cca[4].weapons[8] = {"ix_stunstick", "ix_357", "ix_spas12"}
