...
function PANEL:Init()
    ...
    self.descriptionModel.Entity:SetBodygroup(2, 1)
    self.descriptionModel.Entity:SetBodygroup(3, 1)
	...
	descriptionProceed:SetText("finish")
	...
	self:AddPayloadHook("model", function(value)
		...
		if (faction) then
            ...
            self.factionModel.Entity:SetBodygroup(2, 1)
            self.factionModel.Entity:SetBodygroup(3, 1)
            self.descriptionModel.Entity:SetBodygroup(2, 1)
            self.descriptionModel.Entity:SetBodygroup(3, 1)
            self.attributesModel.Entity:SetBodygroup(2, 1)
            self.attributesModel.Entity:SetBodygroup(3, 1)
		end
	end)
	...
	for k, v in SortedPairsByMemberValue(ix.char.vars, "index") do
		if (!v.bNoDisplay and k != "__SortedIndex") then
			...
			elseif (isstring(v.default)) then
				...
				panel:Dock(TOP)
				panel:SetFont("LiteNetworkFont32")
			...
			if (IsValid(panel)) then
				...
				label:SetFont("LiteNetworkFont32")
