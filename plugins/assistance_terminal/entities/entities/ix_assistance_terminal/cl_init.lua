...
function ENT:Draw()
    ...
    cam.Start3D2D(self:GetPos() + self:GetForward() * 13 + self:GetRight() * 8.5 + self:GetUp() * 20, angle, 0.0364)
        ...
        if ( self:GetNetVar( "alarm" ) ) then
            ...
            draw.SimpleText( "REQUESTER: " .. self:GetNetVar( "requester", "Unidentified" ), "terminal_requestText", 248, 140, Color( 255, 255, 0, 50 + math.abs( math.sin( CurTime() ) ) * 300 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
            ...
            draw.SimpleText( "PRESS TO", "terminal_infoText", 248, 375, Color( 255, 255, 255 ), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER )
