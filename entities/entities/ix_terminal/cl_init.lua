...
function ENT:Draw()
	...
	cam.Start3D2D(pos, ang, 0.07)
		...
		draw.DrawText("DISTRICT INDEX: 47", "ixMenuButtonFontSmall", 8, 32, Color(65, 105, 200), TEXT_ALIGN_LEFT)
...
function PANEL:Init()
	...
	self.sentencebutton:SetText("Emit (Charges: 0 | Cycles: 0)")
...
function PANEL:AddCharge(chargeid, data)
	...
	function chargesetting:OnValueChanged(value)
		...
		panel.sentencebutton:SetText("Sentence to Jail (Charges: "..chargecount.." | Cycles: "..math.Clamp(timecount, 0, (900 / 60))..")")
	end
end
